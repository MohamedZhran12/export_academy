        ...
        <div class="col-sm-9">
          <div class="padding-left-30">
            ...
            <div class="row">
              ...
              <?php
              $sql = $conn->prepare("SELECT * FROM sys_course WHERE sys_course_month = ? ORDER BY sys_course_date ASC");
              $sql->execute([$month]);
              if ($sql->rowCount() > 0) {
                  ...
                  <div class="col-sm-4">
                    <div class="margin-30">
                      <div class="courses-det">
                        <a class="button-1"
                           href="course.php?id=<?php echo $row['sys_course_id']; ?>&cat_id=<?php echo $row['cat_id']; ?>">
                          ...
                          <div class="courses-desc1">
                            ...
                            <div class="courses-pricing">
                              <span class="cutoff">RM <?php echo $row['sys_course_price_before']; ?></span>
