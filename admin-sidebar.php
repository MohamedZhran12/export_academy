  ...
  <div class="background-gradient">
    <div class="side-bar-menu">
      ...
      <ul class='list-unstyled'>
        <li>
          <a href="admin-main.php" class="side-menu-link">Admin Dashboard</a>
        </li>
        <li>
          <a href="admin-all-courses.php" class="side-menu-link">All Courses</a>
        </li>
        <li>
          <a href="admin-all-courses.php?t=sys_seminars" class="side-menu-link">All Seminar & Conferences</a>
        </li>
        <li>
          <a href="admin-all-courses.php?t=sys_professional_cert" class="side-menu-link">All Professional
            Certification</a>
        </li>
        <li>
          <a href="admin-all-courses.php?t=sys_special_programmes" class="side-menu-link">All Special Programmes</a>
        </li>
        <li>
          <a href="admin-all-courses.php?t=sys_trade_missions" class="side-menu-link">All Trade Missions</a>
        </li>
    ...
    <div class="side-bar-menu">
      <p class="menu-topic-side"><i class="fas fa-cloud-upload-alt"></i> Uploads</p>
      <ul class='list-unstyled'>
        ...
        <li>
          <a href="admin-upload-course.php" class="side-menu-link">Upload Course</a>
        </li>
        <li><a href="admin-upload-seminar.php" class="side-menu-link">Upload Seminar &
            Conferences</a>
        </li>
        <li>
          <a href="admin-upload-professional-cert.php" class="side-menu-link">Upload Professional
            Certification</a>
        </li>
        <li>
          <a href="admin-upload-special-programs.php" class="side-menu-link">Upload Special
            Programmes</a>
        </li>
        <li>
          <a href="admin-upload-trade-missions.php" class="side-menu-link">Upload trade
            missions</a>
        </li>
