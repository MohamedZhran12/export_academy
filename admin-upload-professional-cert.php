...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "frm_add_channel") && isset($_FILES['image']['tmp_name'])) {
  ...
  VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,0,?,?,?,?,?,?,?,?)");
    ...
    for ($i = 0; $i < count($start_date); $i++) {
      $insert_dates_stmt .= "('$start_date[$i]','$end_date[$i]',?,$last_inserted_id)";
      if ($i != count($start_date) - 1) {
        $insert_dates_stmt .= ',';
      }
    }
    $isSuccess = $conn->prepare($insert_dates_stmt)->execute();
    if ($isSuccess) {
      echo '
          ...
          <div class="background-white-in">
            <div class="padding-30-15">
              <div class="breadcrumb-main">
                ...
                <p class="current-link">Upload Professional Certification</p>
              </div>
              <br>
                  ...
                  <div class="margin-bottom-30">
                    <div class="background-white">
                      <div class="padding-topic">
                        <p class="menu-topic">Upload Professional Certification</p>
                      </div>
                      <hr>
                                    ...
                                    <div class='col-12 date-picker mb-3'>
                                      <div class='row'>
                                        <div class='col-5'>
                                          <div class="input-group date">
                                            <input type="text" class="form-control" autocomplete='off'
                                                   placeholder='Start Date' name='start_date[]'><span
                                        ...
                                        <div class='col-6'>
                                          <div class="input-group date">
                                            <input type="text" class="form-control" autocomplete='off'
                                                   placeholder='End Date' name='end_date[]'><span
                                                class="input-group-addon"><i class="glyphicon glyphicon-th"></i></span>
                                          </div>
                                        </div>
                                      </div>
