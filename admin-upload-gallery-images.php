...
$stmt = $conn->prepare("select title,id from gallery_categories order by id desc");
$stmt->execute();
  ...
  <div class="row">
    ...
    <div class="col-9 .bg-white">
      <div class="breadcrumb-main mt-5">
        ...
        <p class="current-link">Upload Gallery Images</p>
      </div>
      <form class='mt-5 shadow-sm p-4 mb-5 bg-white rounded' action='upload-gallery.php' method='post'
