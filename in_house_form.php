            ...
            <form action='' method='post'>
              <div class='form-group'>
                ...
                <div class="form-check-inline">
                  <input class="form-check-input" type="radio" name="training_type" id="training_type1"
                         value="Face to Face In  house" checked>
                  <label class="form-check-label" for="training_type1">
                    Face to Face In house
                  </label>
                </div>
                <div class="form-check-inline">
                  <input class="form-check-input" type="radio" name="training_type" id="training_type2"
                         value="Virtual In house">
              ...
              <div class='form-group'>
                ...
                <div class="form-check-inline">
                  <input class="form-check-input" type="radio" name="training_duration" id="training_duration1"
                         value="One day" checked>
                  <label class="form-check-label" for="training_duration1">
                    One day
                  </label>
                </div>
                <div class="form-check-inline">
                  <input class="form-check-input" type="radio" name="training_duration" id="training_duration2"
                         value="Two days">
              ...
              <div class='form-group'>
                <textarea class="form-control" rows="3" placeholder='Please state any special requirements'
