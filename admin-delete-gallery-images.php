...
$stmt = $conn->prepare("select name,path,id from gallery_images");
$stmt->execute();
  ...
  <div class="row">
    ...
    <div class="col-9 .bg-white">
      <div class="breadcrumb-main mt-5">
        ...
        <p class="current-link">Delete Gallery Images</p>
      </div>
      <div class='row'>
    ...
    <script>
      ...
      elements.forEach(ele => {
        ele.addEventListener('click', function(e) {
          ...
          if (isConfirmed) {
            window.location.href = `admin-delete-gallery-images.php?delete=image&image_id=${id}&full_path=${fullPath}`;
          }
        })
      })
    </script>
