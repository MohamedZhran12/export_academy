    ...
    <div class="container">
      <div class="header-in-topic">
        ...
        <div class="breadcrumb-in">
          ...
          <p class="link-at">Public Training</p>
        </div>
      </div>
    </div>
  </div>
        ...
        <div class="col-sm-9">
          <div class="padding-left-30">
            <div class="my-main-list">
              <h2 class="topic-in"><?php echo date("F", strtotime('m')); ?> <?php echo date("Y"); ?> Courses</h2>
            ...
            <div class="row">
              ...
              <?php
              $sql = $conn->prepare("SELECT * FROM sys_course WHERE sys_course_year = YEAR(CURDATE()) AND sys_course_month = MONTH(CURDATE())");
              $sql->execute([]);
              if ($sql->rowCount() > 0) {
