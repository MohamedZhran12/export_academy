  ...
  <div class='container'>
    <div class='row'>
      <div class='col-12 border mb-5 p-5'>
        <h5 class='my-4' style='color:#00a7ff;'><u>Enquiry Form</u></h5>
        <? if (!is_numeric($_GET['topic']) && !empty($_GET['topic'])) { ?>
        ...
        <form method='post'>
          ...
          <? } ?>
          <div class='form-group'>
            <textarea class="form-control" rows="3" placeholder='<? echo isset($_GET['in_house']) && $_GET['in_house'] == 1 ? 'Please state any special requirements' : 'Type your query'; ?> ' name='requirements'></textarea>
          </div>
          <div class='form-group'>
