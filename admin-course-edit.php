...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  $conn->prepare($insert_dates_stmt)->execute();
                            ...
                            <form method="post" enctype="multipart/form-data">
                              <div class="row">
                                <div class="col-sm-6">
                                  ...
                                  <img src="images/courses/<?php echo $row['sys_course_image']; ?>" id='course_image'>
                                  <br>
                                  ...
                                  <div class="row">
                                    <div class="col-sm-12">
                                      ...
                                      <p><input type="text" class="form" name="topic" placeholder="eg: Accounts"
                                                size="30" value="<?php echo $row['sys_course_topic']; ?>"/></p>
                                      <br>
                                    </div>
                                    ...
                                    <div class="col-sm-12">
                                      ...
                                      <p><input type="number" class="form" name="points" placeholder="eg: 11"
                                                value="<?php echo $row['sys_cpd_points']; ?>" size="30"/></p>
                                      <br>
                                    </div>
                                          ...
                                          <div class='row'>
                                            <div class='col-5'>
                                              <div class="input-group date">
                                                <input type="text" value='<? echo $date['course_date_start'] ?>'
                                                       class="form-control" autocomplete='off' placeholder='Start Date'
                                                       name='start_date[]'><span class="input-group-addon"><i
                                            ...
                                            <div class='col-6'>
                                              <div class="input-group date">
                                                <input type="text" value='<? echo $date['course_date_end'] ?>'
                                                       class="form-control" autocomplete='off' placeholder='End Date'
                                                       name='end_date[]'><span class="input-group-addon"><i
                                                      class="glyphicon glyphicon-th"></i></span>
                                              </div>
                                            </div>
                                          </div>
                                    ...
                                    <? } else { ?>
                                      ...
                                      <div class="col-sm-4">
                                        ...
                                        <p>
                                          <select id="form" class="form" name="date">
                                            <option
                                                value="<?php echo $row['sys_course_date']; ?>"><?php echo $row['sys_course_date']; ?></option>
                                      ...
                                      <div class="col-sm-4">
                                        ...
                                        <p>
                                          <select id="form" class="form" name="month">
                                            <option
                                                value="<?php echo $row['sys_course_month']; ?>"><?php echo $row['sys_course_month']; ?></option>
                                      ...
                                      <div class="col-sm-4">
                                        ...
                                        <p>
                                          <input type="number" class="form" name="year"
                                                 value="<?php echo $row['sys_course_year']; ?>">
                                        </p>
                                        <br>
                                      </div>
                                    ...
                                    <div class="col-sm-4">
                                      ...
                                      <p><input type="number" class="form" placeholder="3" name="days"
                                                value="<?php echo $row['sys_course_days']; ?>"></p>
                                      <br>
                                    </div>
                                    ...
                                    <div class="col-sm-4">
                                      ...
                                      <p><input type="time" class="form" id="appt" name="timein"
                                                value="<?php echo $row['sys_course_time']; ?>"></p>
                                      <br>
                                    </div>
                                    ...
                                    <div class="col-sm-4">
                                      ...
                                      <p><input type="time" class="form" id="appt" name="timeout"
                                                value="<?php echo $row['sys_course_timeout']; ?>"></p>
                                      <br>
                                    </div>
                                      ...
                                      <div class="col-12 mb-4">
                                        ...
                                        <select id='group-title' name='group_id' class="custom-select">
                                          ...
                                          <? foreach ($groups as $group) { ?>
                                            <option <? if ($group['ID'] == $row['group_id']) echo 'selected' ?>
                                                value="<? echo $group['ID'] ?>">
                                              <? echo $group['name'] ?>
                                            </option>
                                          <? } ?>
                                    ...
                                    <div class="col-sm-12">
                                      ...
                                      <div class="row">
                                        <div class="col-sm-6">
                                          <p class="side-by-side">Inclusive
                                            <input <?php if ($row['sys_sst'] == 'Inclusive of 6% SST') echo 'checked' ?>
                                                type="radio" name="tax" checked value="Inclusive of 6% SST"/>
                                          </p>
                                        </div>
                                        ...
                                        <div class="col-sm-6">
                                          <p class="side-by-side">Subjected
                                            <input <?php if ($row['sys_sst'] == 'Inclusive of 6% SST') echo 'checked' ?>
                                                type="radio" name="tax" value="Subjected to 6% SST"/>
                                          </p>
                                          <br>
                                        </div>
                                      </div>
                                      ...
                                      <div class="row">
                                        <div class="col-sm-6">
                                          <p class="side-by-side">Inclusive
                                            <input <?php if ($row['sys_sst'] == 'Inclusive of 6% GST') echo 'checked' ?>
                                                type="radio" name="tax" value="Inclusive of 6% GST"/>
                                          </p>
                                        </div>

                                        <div class="col-sm-6">
                                          <p class="side-by-side">Subjected
                                            <input <?php if ($row['sys_sst'] == 'Subjected to 6% GST') echo 'checked' ?>
                                                type="radio" name="tax" value="Subjected to 6% GST"/>
                                          </p>
                                          <br>
                                        </div>
                                      </div>
                                      ...
                                      <div class="row">
                                        <div class="col-sm-6">
                                          <p class="side-by-side">Virtual Programme
                                            <input type="radio" <?php if ($row['cat_id'] == 1) echo 'checked' ?>
                                                   name="cat" value="1" id='virtualClass'/>
                                          </p>
                                        </div>

                                        <div class="col-sm-6">
                                          <p class="side-by-side">Public Programme
                                            <input type="radio" <?php if ($row['cat_id'] == 2) echo 'checked' ?>
                                                   name="cat" value="2" id='publicClass'/>
                                          </p><br>
                                        </div>
                                      </div>
                                      <input <?php if ($row['cat_id'] != 1) echo 'style="display:none;"' ?> class="form"
                                                                                                            type="text"
                                                                                                            name="virtual_venue"
                                                                                                            value="<?php if ($row['cat_id'] == 1) echo $row['sys_course_venue']; ?>"
                                                                                                            id="virtualAnswer"/>
                                      <input <?php if ($row['cat_id'] != 2) echo 'style="display:none;"' ?> class="form"
                                                                                                            type="text"
                                                                                                            name="public_venue"
                                                                                                            value="<?php if ($row['cat_id'] == 2) echo $row['sys_course_venue']; ?>"
                                                                                                            id="publicAnswer"/>
                                      <br>
                                    </div>
                                ...
                                <div class="col-sm-12">
                                  ...
                                  <textarea id="editor3"
                                            name="module"><?php echo $row['sys_course_module']; ?></textarea>
                                ...
                                <div class="col-sm-12">
                                  ...
                                  <p><input type="text" class="form" name="trainer" placeholder="eg: Ali" size="30"
                                            value="<?php echo $row['sys_course_trainer']; ?>"/></p>
                                  <br>
                                </div>
                                ...
                                <div class="col-sm-12">
                                  ...
                                  <textarea id="editor2"
                                            name="trainerinfo"><?php echo $row['sys_course_trainer_info']; ?></textarea>
                                ...
                                <div class="col-sm-6">
                                  ...
                                  <p><input type="number" step="0.01" value="<?php echo $row['sys_course_price']; ?>"
                                            class="form" name="fees" size="30"/></p>
                                  <br>
                                </div>

                                <div class="col-sm-6">
                                  <p class="form-text">Normal Price in MYR</p>
                                  <p><input type="number" step="0.01"
                                            value="<?php echo $row['sys_course_price_before']; ?>" class="form"
                                ...
                                <div class="col-sm-6">
                                  ...
                                  <p><input type="number" step="0.01"
                                            value="<?php echo $row['sys_course_price_usd']; ?>" class="form"
                                            name="fees_usd" size="30"/></p>
                                  <br>
                                </div>
                                ...
                                <div class="col-sm-6">
                                  ...
                                  <p><input type="number" step="0.01"
                                            value="<?php echo $row['sys_course_price_before_usd']; ?>" class="form"
                                            name="feesbefore_usd" size="30"/></p>
                                  <br>
                                </div>
                                <? if ($table == 'sys_special_programmes') { ?>
                                  <div class="col-sm-12">
                                    <span>Show HRDF:</span>
                                    <input type="radio" name="toggle_hrdf"
                                           value='1' <? if ($row['is_hrdf'] == 1) echo 'checked'; ?> /><span> Yes</span>
                                    <input type="radio" name="toggle_hrdf"
                                           value='0' <? if ($row['is_hrdf'] == 0) echo 'checked'; ?> /><span> No</span>
                                  </div>
                                  <div class="col-sm-12">
                                    <span>Show Lunch:</span>
                                    <input type="radio" name="toggle_lunch"
                                           value='1' <? if ($row['is_lunch'] == 1) echo 'checked'; ?> /><span> Yes</span>
                                    <input type="radio" name="toggle_lunch"
                                           value='0' <? if ($row['is_lunch'] == 0) echo 'checked'; ?> /><span> No</span>
                                  </div>
                                  <div class="col-sm-12">
                                    <span>Show Certificate of Attendance:</span>
                                    <input type="radio" name="toggle_cpd_text"
                                           value='1' <? if ($row['is_cpd_text'] == 1) echo 'checked'; ?> /><span> Yes</span>
                                    <input type="radio" name="toggle_cpd_text"
                                           value='0' <? if ($row['is_cpd_text'] == 0) echo 'checked'; ?> /><span> No</span>
                                  </div>
                                <? } ?>
