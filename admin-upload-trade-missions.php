          ...
          <div class="background-white-in">
            <div class="padding-30-15">
              <div class="breadcrumb-main">
                ...
                <p class="current-link">Upload Trade Missions</p>
              </div>
              <br>
                  ...
                  <div class="margin-bottom-30">
                    <div class="background-white">
                      <div class="padding-topic">
                        <p class="menu-topic">Upload Trade Missions</p>
                      </div>
                      <hr>
                          ...
                          <div class="row">
                            <form name="frm_add_channel" method="post" enctype="multipart/form-data">
                              <div class="row">
                                ...
                                <div class="col-sm-12">
                                  <p class="form-text">Mission info</p>
                                ...
                                <div class="col-sm-12">
                                  <p class="form-text">Trade Accelerator (TA)</p>
