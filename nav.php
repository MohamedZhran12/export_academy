<div class="cbp-af-header">
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-3">
          <div class="logo">
            <a href="index.php">
              <img src="images/logo/Malaysia Export Academy Logo.png">
            </a>
          </div>
        </div>
        ...
        <div class="col-9">
          <nav>
            <ul>
              <li <?php if ($_SERVER['SCRIPT_NAME'] == "/index.php") { ?> class="active" <?php } ?>><a href="index.php">Home</a>
              </li>
              ...
              <li><a href="#">Programmes</a>
                ...
                <ul>
                  <li><a href="#">Corporate Training</a>
                    ...
                    <ul>
                      <li><a href="publictraining.php"><i class="fas fa-graduation-cap"></i> Public Training</a></li>
                      <li><a href="inhouse.php"><i class="fas fa-graduation-cap"></i> In-house Training</a></li>
                    </ul>
                  </li>
                  ...
                  <li><a href="online-training.php">Online Training</a>
                    <ul>
                      <li><a href="www.londonvschool.com" target="_blank"><i class="fas fa-graduation-cap"></i>Virtual
                          Learning</a></li>
                      <li><a href="www.mexaonline.com" target="_blank"><i
                              class="fas fa-graduation-cap"></i>E-Learning</a></li>
                    </ul>
                  </li>
                </ul>
              </li>
              ...
              <li><a href="#">Services</a>
                <ul>
                  ...
                  <li><a href="special-programs.php">Others</a></li>
                </ul>
              </li>
              ...
              <li><a href="#">Resource Center</a>
                <ul>
                  <li <?php if ($_SERVER['SCRIPT_NAME'] == "/articles.php") { ?> class="active" <?php } ?>><a
  ...
  <div class="overlay-menu">
    ...
    <ul id="menu">
      ...
      <li><a href="#">Listing of Products</a></li>
      <li><a href="room.php">Hall Rental</a></li>
      <li><a href="coming-soon.php">General Network</a></li>
      <li><a href="mexa-tv.php">MEXA TV</a></li>
      <li><a href="http://www.eexport.org.my/">Cross Border Ecommerce</a></li>
      <li><a href="ourprofile.php">Our Profile</a></li>
      <li><a href="achievements.php">Our Achievements</a></li>
      <li><a href="advisor.php">Board of Advisors</a></li>
      <li><a href="our-management.php">Management Team</a></li>
